#!/bin/zsh
# 尼崎歯科総研 — 毎日投稿バッチ
# launchd（com.amagasakishikasoken.dailypost.plist）から毎日呼び出される。
...
SITE_DIR="/Users/komurasakishoutaira/Desktop/クロード/尼崎歯科総研"
...
# CLIENT_CONFIG環境変数で尼崎用configを直接指定する（2026-07-10・大阪ペット医療ナビと同方式）
export CLIENT_CONFIG="$SURVEY_DIR/client_config_amagasaki.json"
