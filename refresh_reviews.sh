#!/bin/zsh
# 尼崎歯科総研 — 評価・口コミ件数の月次リフレッシュ＋サイト再生成＋公開
...
git push
# 公開はshika-sokenリポジトリのamagasakiブランチから行われる（Cloudflare Pages接続先）
git push https://github.com/komurasakikobe-hub/shika-soken.git main:amagasaki
echo "===== 完了 $(date) ====="
